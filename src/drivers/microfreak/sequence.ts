...
export async function setSequence(
  ...
  // TODO: Implement SysEx write protocol for sequence data
  // This requires understanding:
  // 1. The write command format (different from read)
  // 2. Whether chunks can be written individually or must be sent as a block
  // 3. Any checksums or validation bytes

  console.warn('[MicroFreak Sequence] Writing sequences not yet implemented');
  console.warn('[MicroFreak Sequence] Requires understanding SysEx write protocol');
